		...
		<tbody>
			...
			while ($row=mysqli_fetch_array($result)) {
				...
				<tr>
					...
					<td><a href="../models/delete_user.php?user_id=<?php echo $row['user_id'] ?>" onclick="return confirm('are you want to delete')">Delete</a></td>
					<td><a href="../models/update_user.php?user_id=<?php echo $row['user_id'] ?>" onclick="return confirm('are you want to update')">Update</a></td>
				</tr>
